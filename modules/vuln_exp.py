...
class Vuln_exp(QThread):
    ...
    def __init__(self,exp_path,url,heads_dict,exp_type,cmd,ip,port):
        super().__init__()
        ...
        try:
            ...
            with eventlet.Timeout(20,False):
                try:
                    ...
                    vuln_info = nnnnnnnnnnnn1.do_exp(url,self.heads_dict,self.exp_type,self.cmd,self.ip,int(self.port))
                    # print(vuln_info)
