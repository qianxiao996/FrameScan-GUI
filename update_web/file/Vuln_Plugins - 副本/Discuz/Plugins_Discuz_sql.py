...
def vuln_info():
    info = {
        'vuln_name': 'Discuz 7.2 sql注入漏洞',  # 漏洞名称
        'vuln_referer': 'https://blog.csdn.net/weixin_39852647/article/details/111846292',  # 漏洞来源
        'vuln_author': 'YaoXin',  # 插件作者
        'cms_name': 'Discuz',  # cms_name需要和上级目录保持一致。扫描器自动添加会调用。GUI版本不会调用
        'vuln_description': '''Discuz7.2 SQL注入漏洞利用PHP特性突破GPC，形成SQL注入漏洞。''',
